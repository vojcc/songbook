<template>
  <div class="flex justify-center">
    <div class="flex flex-col h-[calc((100vh - calc(100vh - 100%))-70px)] w-4/5 sm:w-2/3 lg:w-1/2 space-y-6">
      <div></div>
      <div>
      ...
      <div class="flex flex-col flex-grow">
        ...
        <div class="flex justify-end">
          <button @click="insertSong" class="mt-2 bg-transparent hover:bg-gray-200 text-gray-600 font-semibold py-2 px-4 border border-gray-400 drop-shadow-md rounded-md outline-none">
            Zapisz
          </button>
        </div>
